...
const element = (
  <div>
    ...
    <div>
      이정민(‘https://github.com/danmin20’이하 ‘danmin20’) 은(는) 다음의 목적을
    ...
    <div>
      ① 이정민(‘https://github.com/danmin20’이하 ‘danmin20’) 은(는)
    ...
    <p class="ls2">
      <div>
        ① 정보주체는 이정민(‘https://github.com/danmin20’이하 ‘danmin20) 에 대해
        언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.
      </div>
      <div>1. 개인정보 열람요구</div>
      <div> 2. 오류 등이 있을 경우 정정 요구</div> 3. 삭제요구
      <div> 4. 처리정지 요구</div>
    </p>
    <p class="lh6 bs4">
      ...
      <div>
        ...
        ①{" "}
        <em class="emphasis">
          이정민('https://github.com/danmin20'이하 'danmin20')
        </em>
        ...
        <p class="lh6 bs4">
          <strong>
            5. 개인정보의 파기<em class="emphasis">이정민('danmin20')</em>은(는)
        ...
        <p class="ls2">
          ...
          <div>-파기기한</div>이용자의 개인정보는 개인정보의 보유기간이 경과된
        ...
        <p class="ls2">
          ① 이정민 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고
          ...
          <br /> ① 이정민(‘https://github.com/danmin20’이하 ‘danmin20) 은(는)
          ...
          <p class="ls2">
            ...
            직급 :개발자
            <br />
            연락처 :01046326807, ljm991108@gmail.com, <br />※ 개인정보 보호
            담당부서로 연결됩니다.
            <br /> <br />▶ 개인정보 보호 담당부서
            <br />
            부서명 :<br />
            담당자 :<br />
            연락처 :, , <br />② 정보주체께서는
            이정민(‘https://github.com/danmin20’이하 ‘danmin20) 의 서비스(또는
            사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리,
            피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실
            수 있습니다. 이정민(‘https://github.com/danmin20’이하 ‘danmin20)
          ...
          <p class="lh6 bs4">
            <strong>
              9. 개인정보의 안전성 확보 조치{" "}
              <em class="emphasis">이정민('danmin20')</em>은(는) 개인정보보호법
          ...
          <p class="ls2">
            ...
            <div>2. 개인정보에 대한 접근 제한</div> 개인정보를 처리하는
